...
> `normalize_reddit_jsonl.py` and `trash_miner.py` use only the standard library; the miner and gap-analysis pipeline use the packages listed in `requirements.txt`.
