...
def build_phase_plan(args, state):
    """Return phases requested for this invocation in dependency order."""
    phases_to_run = []
...
def main():
    ...
    phases_to_run = build_phase_plan(args, state)

    if not phases_to_run:
        print("[INFO] All requested phases already complete.")
        print(f"\nResults:")
