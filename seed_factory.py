...
def main():
    ...
    added = factory.seeds - before
    if args.source in {"google", "llm"} and not added:
        print("[ERROR] Seed generation produced no new seeds; existing seed file was left unchanged.")
        sys.exit(1)
