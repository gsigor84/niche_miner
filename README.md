...
> `normalize_reddit_jsonl.py` and `trash_miner.py` use only the standard library — the requirements file covers the RSS, scouting, and gap-analysis pipeline dependencies.
